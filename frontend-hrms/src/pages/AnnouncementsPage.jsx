    ...
    <Container maxWidth="xl" sx={{ mt: 3, mb: 4 }}>
      ...
      <Paper sx={{ p: 2, mb: 3 }}>
        <Stack direction="row" spacing={2} alignItems="center">
          ...
          />
          <Chip label={`${filteredAnnouncements.length} results`} color="primary" variant="outlined" size="small" />
        </Stack>
      </Paper>
{/* Announcements List */}
      <Paper sx={{ p: 0, overflow: "hidden", borderRadius: 2 }}>
        ...
        {!loading && filteredAnnouncements.length === 0 && (
          <Box sx={{ p: 10, textAlign: "center", bgcolor: "background.paper" }}>
            ...
            {searchQuery && (
              <Button onClick={() => setSearchQuery("")} sx={{ mt: 2 }} size="small">
                Clear Search
              </Button>
            )}
          </Box>
      ...
      {/* Create Dialog */}
      <Dialog open={createDialogOpen} onClose={handleCreateClose} maxWidth="sm" fullWidth PaperProps={{ sx: { borderRadius: 4, p: 1 } }}>
        <DialogTitle sx={{ pb: 1 }}>
          <Typography variant="h5" component="div" fontWeight={800} color="text.primary">Post Announcement</Typography>
          <Typography variant="body2" component="div" color="text.secondary">Broadcasting to all team members</Typography>
        </DialogTitle>
        ...
        <DialogActions sx={{ p: 3, pt: 1 }}>
          <Button onClick={handleCreateClose} color="inherit" sx={{ fontWeight: 600 }}>Dismiss</Button>
          <Button
            variant="contained"
      ...
      {/* Delete Dialog */}
      <Dialog open={deleteDialogOpen} onClose={handleDeleteClose} maxWidth="xs" fullWidth PaperProps={{ sx: { borderRadius: 4 } }}>
        <DialogTitle>
      ...
      >
        <Alert onClose={() => setSnackbar({ ...snackbar, open: false })} severity={snackbar.severity} variant="filled" sx={{ borderRadius: 3, px: 3, py: 1, fontWeight: 600, boxShadow: 5 }}>
          {snackbar.message}
        </Alert>
      </Snackbar>
    </Container>
